...
namespace GIF_S.Migrations
{
    ...
    [Migration("20250514175349_fifthCRUD")]
    partial class fifthCRUD
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GIF_S.Model.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GIF_S.Model.InstructorForm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CompanyQuestion")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ExperienceQuestion")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GIF_S.Model.Quiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GIF_S.Model.UserCourseEnroll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProgId")
                        .IsUnique()
                        .HasFilter("[ProgId] IS NOT NULL");

                    b.HasIndex("UserId");

                    b.ToTable("UserCourseEnrolls");
                });

            modelBuilder.Entity("GIF_S.Model.UserCourseFavourite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GIF_S.Model.Course", b =>
                {
                    b.HasOne("GIF_S.Model.ApplicationUser", "Author")
                        .WithMany("CreatedCourses")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GIF_S.Model.RoadMap", "RoadMap")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("GIF_S.Model.InstructorForm", b =>
                {
                    b.HasOne("GIF_S.Model.ApplicationUser", "Instructor")
                        .WithMany()
            ...
            modelBuilder.Entity("GIF_S.Model.Question", b =>
                {
                    b.HasOne("GIF_S.Model.Quiz", "Quiz")
                        .WithMany("questions")
            ...
            modelBuilder.Entity("GIF_S.Model.Rate", b =>
                {
                    b.HasOne("GIF_S.Model.UserCourseEnroll", "UserCourse")
                        .WithMany()
            ...
            modelBuilder.Entity("GIF_S.Model.UserCourseEnroll", b =>
                {
                    ...
                    b.HasOne("GIF_S.Model.Progress", "Progress")
                        .WithOne("UserCourse")
                        .HasForeignKey("GIF_S.Model.UserCourseEnroll", "ProgId");
